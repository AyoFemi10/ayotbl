...
// ---------- Rich Messages (Bot API 10.1, expanded 10.2) ----------
// Field names verified against core.telegram.org/bots/api-changelog and a
// community-maintained field-by-field reference, cross-checked against each
// other. This replaces an earlier, incorrect hand-guessed model.
...
export type RichTextTagged =
  ...
  | { type: "date_time"; text: RichText; unix_time: Integer; date_time_format: string }
  | { type: "text_mention"; text: RichText; user: User }
...
export type RichBlock =
  ...
  | { type: "heading"; text: RichText; size: Integer }
  | { type: "pre"; text: RichText; language?: string }
  | { type: "footer"; text: RichText }
  | { type: "divider" }
  | { type: "mathematical_expression"; expression: string }
  | { type: "anchor"; name: string }
  | { type: "list"; items: RichBlockListItem[] }
  ...
  | { type: "table"; cells: RichBlockTableCell[][]; is_bordered?: true; is_striped?: true; caption?: RichText }
  | { type: "details"; summary: RichText; blocks: RichBlock[]; is_open?: true }
  | { type: "map"; location: Location; zoom: Integer; width: Integer; height: Integer; caption?: RichBlockCaption }
  | { type: "animation"; animation: Animation; has_spoiler?: true; caption?: RichBlockCaption }
  | { type: "audio"; audio: Audio; caption?: RichBlockCaption }
  | { type: "photo"; photo: PhotoSize[]; has_spoiler?: true; caption?: RichBlockCaption }
  | { type: "video"; video: Video; has_spoiler?: true; caption?: RichBlockCaption }
  | { type: "voice_note"; voice_note: Voice; caption?: RichBlockCaption }
...
export type InputRichBlock =
  ...
  | { type: "map"; location: Location; zoom: Integer; width: Integer; height: Integer; caption?: RichBlockCaption }
  | { type: "animation"; animation: InputFile; has_spoiler?: true; caption?: RichBlockCaption }
  | { type: "audio"; audio: InputFile; caption?: RichBlockCaption }
  | { type: "photo"; photo: InputFile; has_spoiler?: true; caption?: RichBlockCaption }
  | { type: "video"; video: InputFile; has_spoiler?: true; caption?: RichBlockCaption }
  | { type: "voice_note"; voice_note: InputFile; caption?: RichBlockCaption }
  | { type: "thinking"; text: RichText };
...
// ---------- Inline mode results (Bot API, stable since early versions) ----------
...
export type InlineQueryResult =
  | (InlineQueryResultBase & { type: "article"; title: string; input_message_content: InputMessageContent; url?: string; description?: string; thumbnail_url?: string; thumbnail_width?: Integer; thumbnail_height?: Integer })
  | (InlineQueryResultBase & { type: "photo"; photo_url: string; thumbnail_url: string; photo_width?: Integer; photo_height?: Integer; title?: string; description?: string; caption?: string; parse_mode?: ParseMode; caption_entities?: MessageEntity[]; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "gif"; gif_url: string; gif_width?: Integer; gif_height?: Integer; gif_duration?: Integer; thumbnail_url: string; thumbnail_mime_type?: string; title?: string; caption?: string; parse_mode?: ParseMode; caption_entities?: MessageEntity[]; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "mpeg4_gif"; mpeg4_url: string; mpeg4_width?: Integer; mpeg4_height?: Integer; mpeg4_duration?: Integer; thumbnail_url: string; thumbnail_mime_type?: string; title?: string; caption?: string; parse_mode?: ParseMode; caption_entities?: MessageEntity[]; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "video"; video_url: string; mime_type: string; thumbnail_url: string; title: string; caption?: string; parse_mode?: ParseMode; caption_entities?: MessageEntity[]; video_width?: Integer; video_height?: Integer; video_duration?: Integer; description?: string; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "audio"; audio_url: string; title: string; caption?: string; parse_mode?: ParseMode; caption_entities?: MessageEntity[]; performer?: string; audio_duration?: Integer; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "voice"; voice_url: string; title: string; caption?: string; parse_mode?: ParseMode; caption_entities?: MessageEntity[]; voice_duration?: Integer; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "document"; title: string; caption?: string; parse_mode?: ParseMode; caption_entities?: MessageEntity[]; document_url: string; mime_type: string; description?: string; thumbnail_url?: string; thumbnail_width?: Integer; thumbnail_height?: Integer; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "location"; latitude: number; longitude: number; title: string; horizontal_accuracy?: number; live_period?: Integer; heading?: Integer; proximity_alert_radius?: Integer; thumbnail_url?: string; thumbnail_width?: Integer; thumbnail_height?: Integer; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "venue"; latitude: number; longitude: number; title: string; address: string; foursquare_id?: string; foursquare_type?: string; google_place_id?: string; google_place_type?: string; thumbnail_url?: string; thumbnail_width?: Integer; thumbnail_height?: Integer; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "contact"; phone_number: string; first_name: string; last_name?: string; vcard?: string; thumbnail_url?: string; thumbnail_width?: Integer; thumbnail_height?: Integer; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "game"; game_short_name: string })
  | (InlineQueryResultBase & { type: "sticker"; sticker_file_id: string; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "photo"; photo_file_id: string; title?: string; description?: string; caption?: string; parse_mode?: ParseMode; caption_entities?: MessageEntity[]; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "gif"; gif_file_id: string; title?: string; caption?: string; parse_mode?: ParseMode; caption_entities?: MessageEntity[]; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "mpeg4_gif"; mpeg4_file_id: string; title?: string; caption?: string; parse_mode?: ParseMode; caption_entities?: MessageEntity[]; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "video"; video_file_id: string; title: string; description?: string; caption?: string; parse_mode?: ParseMode; caption_entities?: MessageEntity[]; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "audio"; audio_file_id: string; caption?: string; parse_mode?: ParseMode; caption_entities?: MessageEntity[]; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "voice"; voice_file_id: string; title: string; caption?: string; parse_mode?: ParseMode; caption_entities?: MessageEntity[]; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "document"; document_file_id: string; title: string; description?: string; caption?: string; parse_mode?: ParseMode; caption_entities?: MessageEntity[]; input_message_content?: InputMessageContent })
  | (InlineQueryResultBase & { type: "sticker"; sticker_file_id: string });
...
export type PassportElementError =
  | { source: "data"; type: PassportElementType; field_name: string; data_hash: string; message: string }
  | { source: "front_side"; type: PassportElementType; file_hash: string; message: string }
  | { source: "reverse_side"; type: PassportElementType; file_hash: string; message: string }
  | { source: "selfie"; type: PassportElementType; file_hash: string; message: string }
  | { source: "file"; type: PassportElementType; file_hash: string; message: string }
  | { source: "files"; type: PassportElementType; file_hashes: string[]; message: string }
  | { source: "translation_file"; type: PassportElementType; file_hash: string; message: string }
  | { source: "translation_files"; type: PassportElementType; file_hashes: string[]; message: string }
  | { source: "unspecified"; type: PassportElementType; element_hash: string; message: string };
...
export interface InputMediaPhoto extends InputMediaBase { type: "photo"; has_spoiler?: boolean; show_caption_above_media?: boolean; }
...
export interface InputMediaAnimation extends InputMediaBase { type: "animation"; width?: Integer; height?: Integer; duration?: Integer; has_spoiler?: boolean; show_caption_above_media?: boolean; }
export interface InputMediaAudio extends InputMediaBase { type: "audio"; duration?: Integer; performer?: string; title?: string; }
export interface InputMediaDocument extends InputMediaBase { type: "document"; }
export interface InputMediaVoiceNote { type: "voice_note"; media: InputFile; caption?: string; parse_mode?: ParseMode; duration?: Integer; }
export interface InputMediaSticker { type: "sticker"; media: InputFile; }
export interface InputMediaLocation { type: "location"; latitude: number; longitude: number; }
export interface InputMediaVenue { type: "venue"; latitude: number; longitude: number; title: string; address: string; }
export interface InputMediaLink { type: "link"; link: Link; }

export interface InputMediaLivePhoto { type: "live_photo"; media: InputFile; caption?: string; parse_mode?: ParseMode; has_spoiler?: boolean; show_caption_above_media?: boolean; }

export type InputMedia =
  | InputMediaPhoto | InputMediaVideo | InputMediaAnimation
  | InputMediaAudio | InputMediaDocument | InputMediaLivePhoto;

// ---------- Paid Media (Bot API 7.6+) ----------
...
export type PaidMedia =
  | { type: "preview"; width?: Integer; height?: Integer; duration?: Integer }
  | { type: "photo"; photo: PhotoSize[] }
  | { type: "video"; video: Video }
  | { type: "live_photo"; live_photo: LivePhoto };

export type InputPaidMedia = InputPaidMediaPhoto | InputPaidMediaVideo | InputPaidMediaLivePhoto;
export interface InputPaidMediaLivePhoto { type: "live_photo"; media: InputFile; }
export interface InputPaidMediaPhoto { type: "photo"; media: InputFile; }
...
export interface MessageReactionCountUpdated {
  ...
  message_id: Integer;
  date: Integer;
  reactions: { type: ReactionType; total_count: Integer }[];
}
...
export type ChatBoostSource =
  ...
  | { source: "giveaway"; giveaway_message_id?: Integer; user?: User; prize_star_count?: Integer; is_unclaimed?: boolean };
...
// ---------- Stories & mini-app data-sharing requests ----------
...
// ---------- Chat backgrounds (Bot API 7.0+) ----------

export type BackgroundFill =
  | { type: "solid"; color: Integer }
  | { type: "gradient"; top_color: Integer; bottom_color: Integer; rotation_angle: Integer }
  | { type: "freeform_gradient"; colors: Integer[] };

export type BackgroundType =
  | { type: "fill"; fill: BackgroundFill; dark_theme_dimming: Integer }
  | { type: "wallpaper"; document: Document; dark_theme_dimming: Integer; is_blurred?: boolean; is_moving?: boolean }
  | { type: "pattern"; document: Document; fill: BackgroundFill; intensity: Integer; is_inverted?: boolean; is_moving?: boolean }
  | { type: "chat_theme"; theme_name: string };

export interface ChatBackground {
  type: BackgroundType;
}

// ---------- Stories (Business accounts, Bot API 7.8+) ----------
// StoryArea and InputStoryContent field names below are a best-effort model
// (general structure confirmed via changelog mentions; not field-by-field
// cross-checked the way the rest of this file was) — verify against
// core.telegram.org/bots/api before depending on them heavily.

export type StoryAreaType =
  | { type: "location"; latitude: number; longitude: number; address?: LocationAddress }
  | { type: "suggested_reaction"; reaction_type: ReactionType; is_dark?: boolean; is_flipped?: boolean }
  | { type: "link"; url: string }
  | { type: "weather"; temperature: number; emoji: string; background_color: Integer }
...
export type InputStoryContent =
  | { type: "photo"; photo: InputFile }
  | { type: "video"; video: InputFile; duration?: number; cover_frame_timestamp?: number; is_animation?: boolean };
...
// ---------- Gifts (Bot API 8.0+) ----------
// Model/Symbol/Backdrop confirmed via python-telegram-bot's generated docs
// (which are themselves generated from Telegram's official schema). A few
// deeper fields (e.g. inside AcceptedGiftTypes' nested usage) may still be
// incomplete — check core.telegram.org/bots/api if you hit something missing.
...
export type TransactionPartner =
  ...
  | { type: "chat"; chat: Chat; gift?: Gift }
  | { type: "affiliate_program"; sponsor_user?: User; commission_per_mille: Integer }
  | { type: "fragment"; withdrawal_state?: Record<string, unknown> }
  | { type: "telegram_ads" }
  | { type: "telegram_api"; request_count: Integer }
  | { type: "other" };
...
// Lets bots be @mentioned in chats they aren't a member of. Field names here
// are less thoroughly cross-checked than most of this file — verify against
// current docs before depending on them heavily.
